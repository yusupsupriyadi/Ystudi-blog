        ...
        <div className="container py-32">
            <div className="bg-white dark:bg-gray-800 w-full max-w-sm rounded-lg shadow-md overflow-hidden mx-auto">
                <div className="py-4 px-6">
                    ...
                    <form>
                        <div className="mt-4 w-full">
                            <input className="w-full mt-2 py-2 px-4 bg-white dark:bg-gray-800 text-gray-700 border border-gray-300 dark:border-gray-600 rounded block placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="email" placeholder="Name" aria-label="Email Address" />
                        </div>
                        <div className="mt-4 w-full">
                ...
                <div className="flex items-center justify-center py-4 bg-gray-100 dark:bg-gray-700 text-center">
                    <span className="text-gray-600 dark:text-gray-200 text-sm">have an account? </span>
                    <Link href="Login">
                        <a className="text-blue-600 dark:text-blue-400 font-bold mx-2 text-sm hover:text-blue-500">Login</a>
                    </Link>
