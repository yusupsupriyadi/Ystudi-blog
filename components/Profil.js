...
function Profil() {
    return (
        <div className="text-gray-700 body-font bg-white dark:bg-gray-900">
            <div className="container px-4 mx-auto lg:px-4">
                <div className="flex flex-wrap -m-4">
                    <div className=" mx-auto mb-6 lg:w-1/3 lg:mb-0">
                        <div className="h-full text-center py-16 lg:py-32">
                            ...
                            <h2 className="mt-12 font-medium tracking-wider text-gray-900 title-font dark:text-gray-100 text-lg">Yusup Supriyadi</h2>
